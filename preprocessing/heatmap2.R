...
# Load CSVs
df.prot_data.all <- read.csv("../data/extraction_retry/protein_data_hiv_all_filtimp_k10.csv", header=TRUE, row.names = 1)
df.prot_data.hiv_pos <- read.csv("../data/extraction_retry/protein_data_hiv_pos_filtimp_k10.csv", header=TRUE, row.names = 1)
df.prot_data.hiv_neg <- read.csv("../data/extraction_retry/protein_data_hiv_neg_filtimp_k10.csv", header=TRUE, row.names = 1)
