...
#sum(
round(length(df.gene_data.ex$group[df.gene_data.ex$group==1]) * 0.8)
#,
round(length(df.gene_data.ex$group[df.gene_data.ex$group==2]) * 0.8)
#,
round(length(df.gene_data.ex$group[df.gene_data.ex$group==3]) * 0.8)
#,
round(length(df.gene_data.ex$group[df.gene_data.ex$group==4]) * 0.8)
#,
round(length(df.gene_data.ex$group[df.gene_data.ex$group==5]) * 0.8)
#,
round(length(df.gene_data.ex$group[df.gene_data.ex$group==6]) * 0.8)
#)

# Write to .csv file
write.csv(df.gene_data.ex[,-c(1:7)],"../../data/ex_6/gene_data_body.csv",row.names=TRUE)
write.csv(df.gene_data.ex[,c(1:7)],"../../data/ex_6/gene_data_meta.csv",row.names=TRUE)
