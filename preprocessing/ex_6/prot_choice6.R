...
#sum(
round(length(df.prot_data.ex$group[df.prot_data.ex$group==1]) * 0.8)
#,
round(length(df.prot_data.ex$group[df.prot_data.ex$group==2]) * 0.8)
#,
round(length(df.prot_data.ex$group[df.prot_data.ex$group==3]) * 0.8)
#,
round(length(df.prot_data.ex$group[df.prot_data.ex$group==4]) * 0.8)
#,
round(length(df.prot_data.ex$group[df.prot_data.ex$group==5]) * 0.8)
#,
round(length(df.prot_data.ex$group[df.prot_data.ex$group==6]) * 0.8)
#)

# Write to .csv file
write.csv(df.prot_data.ex[,-c(1:7)],"../../data/ex_6/prot_data_body.csv",row.names=TRUE)
write.csv(df.prot_data.ex[,c(1:7)],"../../data/ex_6/prot_data_meta.csv",row.names=TRUE)
