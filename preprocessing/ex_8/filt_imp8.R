setwd("/project/home17/whb17/Documents/project3/project_files/preprocessing/ex_8/")

inp.data <- read.csv("../../data/ex_8/gene_data_body.csv", header=TRUE, row.names = 1) # Original
...
write.csv(X.imp[-nrow(X.imp),], file="../../data/ex_8/gene_data_body_logtransformed_filtimp_k20.csv", row.names=TRUE)
