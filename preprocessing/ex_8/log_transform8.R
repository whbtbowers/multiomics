...
# Normalised datasets
#df.gene.body.wn <- read.csv("../../data/ex_8/gene_data_body_wn.csv", header=TRUE, row.names = 1)
#df.prot.body.wn <- read.csv("../../data/ex_8/prot_data_body_wn.csv", header=TRUE, row.names = 1)
...
for (i in 1:length(datasets)){
  ...
  write.csv(data.corr.logged, file=paste("../../data/ex_8/", abbrv, "_data_body_lt2.csv", sep=""), row.names=TRUE)
  ...
  write.csv(data.corr.logged.qn, file=paste("../../data/ex_8/", abbrv, "_data_body_lt2_qn.csv", sep=""), row.names=TRUE)
