...
venn.diagram(x = list(
  "TB vs OD" = sel.prot.tb_od$features,
  "TB vs LTBI" = sel.prot.tb_ltbi$features,
  "TB vs non-TB" = sel.prot.tb_nontb$features

),
filename = paste("../../img/", ex_dir, date, "lasso_sel_prot_venn.png", sep=""),
imagetype = "png",
col = "transparent",
fill = c("cornflowerblue", "green", "yellow"),
main = "Number of selected proteins"
)
