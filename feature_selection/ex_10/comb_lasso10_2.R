...
sel.gene.tb_od <- read.csv("../../data/ex_10/feat_sel_1_2/gene_tb_od_BH_LFC_sig_factors.csv", header=TRUE, row.names = 1)
...
sel.gene.tb_ltbi <- read.csv("../../data/ex_10/feat_sel_1_2/gene_tb_od_BH_LFC_sig_factors.csv", header=TRUE, row.names = 1)
...
sel.gene.tb_nontb <- read.csv("../../data/ex_10/feat_sel_1_2/gene_tb_nontb_BH_LFC_sig_factors.csv", header=TRUE, row.names = 1)
